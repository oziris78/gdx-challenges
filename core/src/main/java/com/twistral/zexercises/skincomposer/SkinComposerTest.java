...
public class SkinComposerTest implements ApplicationListener {
    ...
    public void create() {
        ...
        Skin skin = new FreeTypeSkin(Gdx.files.internal("skinComposerTest/toriaSkin/out/toria-skin.json"));
//        Skin skin = new FreeTypeSkin(Gdx.files.internal("skinComposerTest/toriaSkin2/out/toria-skin.json"));
