...
public class NoiseImageMain implements ApplicationListener {
    ...
    public void create() {
        ...
        try { ToriaGDX.openFileExplorer(Gdx.files.local("generated/noise_img_results")); }
